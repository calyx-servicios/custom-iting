...
This module extends the functionality of Sale to add Pre-sales users who had anything to do with previous stages
...
1. Go to Sale, add pre-sale user/s. This field is required
...
* Help Contact moegg@calyxservicios.com.ar
