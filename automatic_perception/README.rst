...
.. |badge2| image:: https://img.shields.io/badge/licence-AGPL--3-blue.png
    ...
    :alt: License: AGPL-3
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fcustom--iting-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/custom-iting
    :alt: calyx-servicios/custom-iting.git
...
* Find module "automatic_perception" > Press Install

* Go to Accounting > Settings > Import Padron > and see the modifications
...
This module is part of the `Iting <https://github.com/calyx-servicios/custom-iting.git>`_ project on GitHub.