...
This module extends the functionality of crm leads to support multi company 
and to allow you to only see the leads of you current company
...
Search CRM Rules Extension in apps.

Usage
=====

1. Activate multi company options.
2. Set the company in the users.
3. Install CRM.
4. Go to CRM.
...
This module is part of the `Custom_iting <https://gitlab.com/calyxservicios-group/odoo/custom_iting>`_ project on Gitlab.